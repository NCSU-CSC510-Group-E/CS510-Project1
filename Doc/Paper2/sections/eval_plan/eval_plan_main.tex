...
% Cosne Simularity is normally used to measure semantics - DAta did not have good semanticss. Good not distinquich between topics well. Data may also not be different enough. Python is close to Javascript - CS language. ADD TO CONCLUSION AT END OF SECTION
